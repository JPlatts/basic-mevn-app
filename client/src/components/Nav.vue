...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <router-link class="navbar-brand" to="/">Restore De-Identification Import</router-link>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       <!-- 
        <li v-if="isAuthenticated" class="nav-item">
          <router-link class="nav-link" to="/deidentifier"><fai icon="gear" /> Restore Registry De-Identification Process</router-link>
        </li>
        <li class="nav-item">
          <router-link class="nav-link" to="/about"><fai icon="circle-info" /> About</router-link>
        </li>
        -->
      </ul>
      <div class="d-flex">
